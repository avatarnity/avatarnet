...
- The same way Chrome is the browser for the internet, Avatarnet has its own browser **Avataroam**. You open a tab, type a `.avtr` address like `einstein.avtr`, and it loads the avatar's mind from the network.
- The same way Google is the search engine for websites, Avatarnet has its own search engine **Avatarfind**, indexing avatars across the network so you can discover people, ideas, and knowledge.
