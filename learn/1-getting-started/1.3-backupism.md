...
Avatarnet's answer is to spread the risk across the globe and beyond through **reciprocal redundancy**. Every piece of content gets replicated across the network based on a **replication factor** you choose, starting at 3 (the protocol minimum) and going up to your level's ceiling (3, 9, 27, 81, 243, 729, or 2,187 copies at L1 through L7). Set it to 27 at L3 and you guarantee 27 copies of your mind across the network. The catch is that you must commit proportional hosting in return, multiplied by L3's 1:5 ratio: `27 × 5 = 135` times the size of your **mind bucket** (your personal storage allocation, which grows daily at your level's L+2 MB/day rate and caps per level).

Only one copy of your mind needs to survive to achieve **Artificial Eternity**, the state where your avatar persists indefinitely on the network, sustained by the surplus of future generations. As long as one copy exists out of 27, the network will restore the remaining 26 when it recovers. Your accumulated hosting position, the level you have reached, the eternal floor copies you have earned, is tracked as your **Network Estate**, the property you build on network land through years of contribution. From one generation to another, your avatar keeps hopping across the network like a flame carried from torch to torch. The same fire keeps burning even as each torch gets replaced, the same avatar keeps living even as the machines get replaced.
...
The next page [Avatar + Mind = You](/learn/getting-started/avatar-and-mind) explains what a Network Estate is, what an Avatar is, what the Mind contains, and how the three together represent everything worth preserving about you.
