...
is a cryptographically signed wiki of a person's knowledge and memories,
replicated across a peer-to-peer network.

**Live site:** <https://avatarnet.org>

---

## The Four Pillars

Every protocol operation upholds these four cryptographic guarantees.
...
site/     The avatarnet.org website, built with Rspress (AGPL-3.0)
```
